...
?>
        ...
        <span style="position:absolute; margin-left: 4%; width:96%; height:100%; top:0;left: 0; z-index: 1" ></span>
        </a>
        <?php if ($retweet_sign) { ?>
        ...
        <div>
        <p> 
        <a style="position: relative; z-index:1000; color:black; padding-left: 2%" href="<?php echo $tweet_user->username;  ?>">
        ...
        <!-- Tweet Content -->
        <p class="tweet-links" style="padding-left: 2%;">
        <?php
