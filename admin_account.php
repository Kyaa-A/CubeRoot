      ...
      <div class="sidebar-left">
        ...
        <a href="admin_panel.php">
          <div class="grid-sidebar" style="margin-top: 30px;">
            ...
            <div class="wrapper-left-elements">
              <a href="admin_panel.php" style="margin-top: 4px"><strong>Admin Panel</strong></a>
            </div>
          </div>
        </a>
        ...
        <a href="<?php echo BASE_URL . "admin_account.php"; ?>">
          <div class="grid-sidebar " style="margin-top: 30px">
            ...
            <div class="wrapper-left-elements">
              <a class="wrapper-left-active" href="<?php echo BASE_URL . "admin_account.php"; ?>" style="margin-top: 4px"><strong>Settings</strong></a>
            </div>
